...
const recipesPlaylist = () => {
  return fetch(`https://www.googleapis.com/youtube/v3/playlistItems?part=snippet%2C+id&playlistId=PLfjCPTMx3kCppMEQ-OIMWLKvpOrXrDX-b&key=${process.env.REACT_APP_YOUTUBE_API_KEY}`)
...
const getVideos = () => {
  return fetch(`https://www.googleapis.com/youtube/v3/playlistItems?playlistId=UU7s6USfYN4-_Wk6roCXtdjg&key=${process.env.REACT_APP_YOUTUBE_API_KEY}&part=snippet&maxResults=20`)
}
